                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
													<li><a class="page-scroll" href="login_inicio.php">LOGIN BÁSICO</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                  </div><!-- /.container -->
                </nav>
					...
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								...
								<br>
								<form action="login_processa_adm.php" method="post">
  							<div class="form-group">
    						<label for="exampleInputEmail1">LOGIN</label>
    						<input type="text" name="usuario" class="form-control" aria-describedby="emailHelp" placeholder="Enter login...">
  							</div>
								<br>
  							<div class="form-group">
